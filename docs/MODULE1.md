...
Follow this path to learn **IEEE 1364-1995 (Verilog-95)** in order:

1. **Skim this document** — Goal, Overview, and Topics Covered set the IEEE scope for Module 1.
2. **Study design architecture** — See how DUTs, examples, and testbenches fit together under `module1/`.
3. **Work through labs in order** — Open `module1/EXAMPLES.md` and run each `make clean && make run` from the repo root.
4. **Run the full module script** — `./scripts/module1.sh` from the repo root to simulate all examples and tests.
...
7. **Self-check** — Use `module1/CHECKLIST.md` before starting the next module.
