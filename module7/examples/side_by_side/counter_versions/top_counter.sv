/*
 * Module 7: Top - run all counter versions and compare
 */
...
module top;
    ...
    initial begin
        $display("Module 7: Side-by-side counter (1995, 2001, 2005, 1800)");
        rst_n = 0; en = 1;
        #20 rst_n = 1;
        #100 $display("  count: c1995=%d c2001=%d c2005=%d c1800=%d", c1995, c2001, c2005, c1800);
        if (c1995 === c2001 && c2001 === c2005 && c2005 === c1800)
